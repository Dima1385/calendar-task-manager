...
- **Week & Month calendar views** with toggle and navigation
...
- **Task filtering** via search bar with highlighting
...
- **Node.js** >= 18
- **MongoDB** running locally (or MongoDB Atlas for production/Vercel)
